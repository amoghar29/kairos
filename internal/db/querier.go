...
type Querier interface {
	...
	GetJobAttempt(ctx context.Context, arg GetJobAttemptParams) (JobAttempt, error)
	...
	RecentAttempts(ctx context.Context, arg RecentAttemptsParams) ([]RecentAttemptsRow, error)
